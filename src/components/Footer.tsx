...
export default function Footer() {
  ...
  return (
    <footer className="relative pt-16 md:pt-24 pb-8 border-t border-white/5">
      {/* ✅ إصلاح: استبدلنا left-1/2 -translate-x-1/2 بـ inset-x-0 mx-auto لدعم RTL */}
      <div className="absolute top-0 inset-x-0 mx-auto w-[600px] h-[300px] bg-brand-blue/5 rounded-full blur-[120px]" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 mb-12 md:mb-16">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-8 rounded-sm overflow-hidden flex flex-col shadow-lg border border-white/10 shrink-0">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-green-500/10 flex items-center justify-center group-hover:bg-green-500/20 transition-colors shrink-0">
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-pink-500/10 flex items-center justify-center group-hover:bg-pink-500/20 transition-colors shrink-0">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
